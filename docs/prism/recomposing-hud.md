...
la méthode la plus performante dans Vulkan consiste à utiliser les unités de transfert matériel (DMA) plutôt que les unités de calcul (Shaders).


## 1. Implémentation par Batching de Régions
