...
public:
    ...
    void prepare(TestData& data) override {
        ...
        // Geometry: A deep trapezoid in screen space
        // Near (Bottom) at Z=0.9, Far (Top) at Z=0.1
        data.addStrip({
            // { x,      y,      z,     color,               offset, u,    v }
            { 100.0f,  450.0f, 0.9f, {255, 255, 255, 255}, {0,0,0,0}, 0.0f, 1.0f }, // Bottom-Left (Near)
            { 540.0f,  450.0f, 0.9f, {255, 255, 255, 255}, {0,0,0,0}, 1.0f, 1.0f }, // Bottom-Right (Near)
            { 250.0f,  150.0f, 0.1f, {255, 255, 255, 255}, {0,0,0,0}, 0.0f, 0.0f }, // Top-Left (Far)
            { 390.0f,  150.0f, 0.1f, {255, 255, 255, 255}, {0,0,0,0}, 1.0f, 0.0f }  // Top-Right (Far)
        }, batch);
    }
};
